                                        ...
                                        <ul class="navbar-nav">
                                            ...
                                            <?php if ($data->fac_role == 'HOD') { ?>
                                                ...
                                                <li class="nav-item dropdown active">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item active" href="fas_overview.php?hash=<?php echo convert_string('decrypt', $data->fac_passkey) ?>">Overview</a></li>
                                                        <li class="dropdown-divider"></li>
                            ...
                            <div class="d-flex flex-column h-100 bg-light rounded-lg box-shadow-lg p-4">
                                <div class="py-1 p-md-3 mt-3  border-bottom">
                                    ...
                                    <div class="d-sm-flex align-items-center justify-content-between pb-2 text-center text-sm-left">
                                        <h1 class="h3 mb-2 text-nowrap">Student Event Report <span class="ml-2 badge badge-primary"><?php echo $user->dept_event_std($user->data()->fac_dept_hash) ?></span></h1>
                                    </div>
                                    <!-- Content-->
                                </div>
                                <div class="row mt-2">
                                            ...
                                            <div class="">
                                                <div class="d-sm-flex align-items-start justify-content-between py-2 py-sm-2">
                                                    ...
                                                    <div class="ml-4 ml-sm-0 py-2">
                                                        <h3 class="mb-2 ml-4">Paper Presentation</h3>
                                                    </div>
                                                    <?php
                                                    $jp = $db->get('fas_event', array('fe_activity', '=', 'Paper Presentation'));
                                                    if ($jp->count()) {
                                                        $jpc = $jp->count();
                                                    } else {
                                                        $jpc = 0;
                                        ...
                                        <div class="card border-0 box-shadow">
                                            <div class="">
                                                <div class="d-sm-flex align-items-start justify-content-between py-2 py-sm-2">
                                                    ...
                                                    <div class="ml-4 ml-sm-0 py-2">
                                                        <h3 class="mb-2 ml-4">Workshop</h3>
                                                    </div>
                                                    <?php
                                                    $co = $db->get('fas_event', array('fe_activity', '=', 'Workshop'));
                                                    if ($co->count()) {
                                                        $coc = $co->count();
                                                    } else {
                                                        $coc = 0;
                                        ...
                                        <div class="card border-0 box-shadow">
                                            <div class="">
                                                <div class="d-sm-flex align-items-start justify-content-between py-2 py-sm-2">
                                                    ...
                                                    <?php
                                                    $gl = $db->get('fas_event', array('fe_activity', '=', 'Courses'));
                                                    if ($gl->count()) {
                                                        $glc = $gl->count();
                                                    } else {
                                                        $glc = 0;
                                        ...
                                        <div class="card border-0 box-shadow">
                                            <div class="">
                                                <div class="d-sm-flex align-items-start justify-content-between py-2 py-sm-2">
                                                    ...
                                                    <div class="ml-4 ml-sm-0 py-2">
                                                        <h3 class="mb-2 ml-4">Contest</h3>
                                                    </div>
                                                    <?php
                                                    $gl = $db->get('fas_event', array('fe_activity', '=', 'Contest'));
                                                    if ($gl->count()) {
                                                        $glc = $gl->count();
                                                    } else {
                                                        $glc = 0;
                                        ...
                                        <div class="card border-0 box-shadow">
                                            <div class="">
                                                <div class="d-sm-flex align-items-start justify-content-between py-2 py-sm-2">
                                                    ...
                                                    <div class="ml-4 ml-sm-0 py-2">
                                                        <h3 class="mb-2 ml-4">Bootcamp</h3>
                                                    </div>
                                                    <?php
                                                    $gp = $db->get('fac_event', array('fe_activity', '=', 'Bootcamp'));
                                                    if ($gp->count()) {
                                                        $gpc = $gp->count();
                                                    } else {
                                                        $gpc = 0;
                                        ...
                                        <div class="card border-0 box-shadow">
                                            <div class="">
                                                <div class="d-sm-flex align-items-start justify-content-between py-2 py-sm-2">
                                                    ...
                                                    <div class="ml-4 ml-sm-0 py-2">
                                                        <h3 class="mb-2 ml-4">Internship</h3>
                                                    </div>
                                                    <?php
                                                    $gc = $db->get('fas_event', array('fe_activity', '=', 'Internship'));
                                                    if ($gc->count()) {
                                                        $gcc = $gc->count();
                                                    } else {
                                                        $gcc = 0;
                                        ...
                                        <div class="card border-0 box-shadow">
                                            <div class="">
                                                <div class="d-sm-flex align-items-start justify-content-between py-2 py-sm-2">
                                                    ...
                                                    <?php
                                                    $go = $db->get('fas_event', array('fe_activity', '=', 'Others'));
                                                    if ($go->count()) {
                                                        $goc = $go->count();
                                                    } else {
                                                        $goc = 0;
                                ...
                                <div class="row border-top mt-4">
                                    <?php
                                    $fac_event = $db->get('fas_event', array('fe_dept_hash', '=', $data->fac_dept_hash));
                                    if ($fac_event->count()) {
                                        foreach ($fac_event->results() as $row) {
                                            $fas = new Student($row->fe_std_hash);
                                            $fas_data = $fas->data();
                                                ...
                                                <div class="card border-0 box-shadow">
                                                    <div class="card-body">
                                                        <div class="text-center">
                                                            <?php if ($fas_data->fac_image) { ?>
                                                                <img class="d-inline-block rounded-circle mb-1 text-center" width="96" src="data:image/png;base64,<?php echo base64_encode($fas_data->fac_image) ?>" alt="<?php echo $fas_data->fac_name ?>" />
                                                            <?php } else { ?>
                                                                <img class="d-inline-block rounded-circle mb-1 text-center" width="96" src="../img/blank.png" alt="<?php echo $fas_data->fac_name ?>" />
                                                            <?php } ?>
                                                        </div>
                                                        <h3 class="h6 pt-1 mb-1 text-center"><?php echo $fas_data->fac_name ?></h3>
