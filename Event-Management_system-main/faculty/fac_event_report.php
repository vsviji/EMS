                                            ...
                                            <?php if ($data->fac_role == 'HOD') { ?>
                                                <li class="nav-item dropdown active">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li class="dropdown-divider"></li>
                                                        <li><a class="dropdown-item active" href="fac_event_report.php?hash=<?php echo convert_string('decrypt', $data->fac_passkey) ?>">Event Report</a></li>
                                                    </ul>
                                                </li>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control custom-select" name="e_activity">
                                                        ...
                                                        <option value="Industrial Traning">Industrial Traning</option>
                                                        <option value="Technical Book Publications">Technical Book Publications</option>
