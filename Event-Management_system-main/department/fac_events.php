            ...
            <div class="container bg-overlay-content pb-4 mb-md-3" style="margin-top: -350px">
                <div class="d-flex flex-column h-100 bg-light rounded-lg box-shadow-lg p-4">
                        ...
                        <div class="row mt-4">
                            <div class="col-xl-4">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <select class="form-control custom-select" name="e_mentor" id="e_mentor">
                            ...
                            <div class="col-xl-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control custom-select" id="e_activity" name="e_activity">
                            ...
                            <div class="col-xl-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="e_year" placeholder="Academic Year" id="e_year">
                                    </div>
                                </div>
                            </div>                            
                            <div class="col-xl-8">                                
                                ...
                                <div class="form-group">                                    
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text font-weight-medium">
                                                <i class="fe-calendar mr-1"></i> Date range
                                            </span>
                                        </div>
                                        <input class="form-control cs-date-picker cs-date-range cs" name="e_sdate" id="start-date" type="text" placeholder="From date" data-datepicker-options='{"altInput": true, "altFormat": "F j, Y", "dateFormat": "Y-m-d"}' data-linked-input="#end-date">
                            ...
                            <div class="col-xl-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text font-weight-medium">Venue</span>
                                        </div>
                                        <select class="form-control custom-select" id="e_venue" name="e_venue">
                                            <option value="">Choose venue...</option>
                                            <?php
                                            $fac = "SELECT DISTINCT fe_venue FROM dept_event WHERE fe_dept_hash = :_hash AND fe_status = :_status";
                                            $statement = $connect->prepare($fac);
                                            $statement->execute(array(
                                                ':_hash' => $data->dept_passkey,
                                                ':_status' => 'Active'
                                            ));
                                            if ($statement->rowCount()) {
                                                foreach ($statement->fetchAll() as $row) {
                                                    echo '<option value="' . $row["fe_venue"] . '">' . $row["fe_venue"] . '</option>';
                                                }
                                            } else {
                                                echo '<option value="">Venue Not Found</option>';
                                            }
                                            ?>
                                        </select>                                         
                                    </div>
                    ...
                    <div class="table-responsive mt-4">
                        <table class="table table-hover" id="fac_table">
        ...
        <script>
            var std = $('#fac_table').DataTable({             
                ...
                "ajax": {
                    ...
                    'data': function(d){
                        return $.extend({},d,{
                            "e_mentor": $('#e_mentor').val(),
                            "e_activity": $('#e_activity').val(),
                            "e_year": $('#e_year').val(),
                            "e_sdate": $('#start-date').val(),
                            "e_edate": $('#end-date').val(),
                            "e_venue": $('#e_venue').val()
                        });
                    }
                },
            ...
            $(document).ready(function() {
                ...
                /* fetch_facdata();
                function fetch_facdata(mentor = '', activity = '', year = '', start_date = '', end_date = ''){
                    var std = $('#fac_table').DataTable({
                        "searching": false,
                        "ordering": false,
                        "paging": false,
                        ...
                        "ajax": {
                            url:'fetch.php',
                            method : 'post',
                            data:{e_mentor:mentor,e_activity:activity,e_year:year,e_sdate:start_date,e_edate:end_date}
                        },
                        buttons: [
                            'print',
                            'copyHtml5',
                ...
                $(document).on('click', '#e_submit', function(a) {
                    a.preventDefault();
                    var mentor = $('#e_mentor').val();
                    var activity = $('#e_activity').val();
                    var year = $('#e_year').val();
                    var start_date = $('#start-date').val();
                    var end_date = $('#end-date').val();                    
                    if(mentor != '' || activity != '' || year != '' || start_date != '' || end_date != ''){                        
                        fetch_facdata(mentor,activity,year,start_date,end_date);    
                        //$('#fac_table').DataTable().destroy();                    
                    }else{
                        $('#fac_table').DataTable().draw();
                        fetch_facdata();
                    }
                });
                */
                ...
                std.draw();
                $('#e_mentor,#e_activity,#e_year,#start-date,#end-date,#e_venue').bind("keyup change",function(){                   
                    std.draw();
                });
