                                        ...
                                        <ul class="navbar-nav">
                                            ...
                                            <li class="nav-item dropdown active">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li class="dropdown-divider"></li>                                        
                                                    <li><a class="dropdown-item active" href="event_create.php?hash=<?php echo convert_string('decrypt',$data->fac_hash) ?>">Event Participated</a></li>                                        
                                                </ul>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="col-lg-4 mb-4 mb-lg-0">
                                    <div class="bg-light rounded-lg box-shadow-lg">
                                        ...
                                        <div class="d-lg-block collapse pb-2" id="account-menu">
                                            ...
                                            <a class="d-flex align-items-center nav-link-style px-4 py-3 active" href="event_create.php?hash=<?php echo convert_string('decrypt',$data->fac_hash) ?>">
                                                Event Participate
                                            </a>
                                        ...
                                        <div class="py-2 p-md-3">
                                            ...
                                            <form method="post" id="e_form" enctype="multipart/form-data">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label for="file-input">Certificate Link</label> 
                                                            <div class="custom-file">
                                                                <input class="form-control" type="text" placeholder="Paste Certificate Link" id="file-input" name="e_cer_link">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label for="file-input">Image Link</label> 
                                                            <div class="custom-file">
                                                                <input class="form-control" type="text" placeholder="Paste Image Link" id="file-input" name="e_img_link">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        ...
                                                        <input type="hidden" name="fac_men_hash" value="<?php echo convert_string('decrypt',$data->fac_mentor_hash) ?>">
