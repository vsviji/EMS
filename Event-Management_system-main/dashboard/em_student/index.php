							...
							<div class="col-xl-4">
								<div class="card card-custom card-stretch bg-light-primary gutter-b">
									...
									<div class="card-body pt-8">
										<?php 
											$query = "SELECT * FROM em_students ORDER BY fac_id DESC";
										...
										?>
											...
											<div class="d-flex align-items-center mb-10">
												...
												<div class="d-flex flex-column font-weight-bold">
													<a href="profile/index.php?emd_department_hash=<?php echo convert_string('decrypt',$row["fac_hash"]) ?>&&em_admin=<?php echo convert_string('decrypt',$user->data()->passkey) ?>" class="text-dark text-hover-primary mb-1 font-size-lg"><?php echo $row["fac_name"] ?></a>
													<span class="text-muted"><i class="fa fa-1x fa-clock text-warning mr-2"></i><?php echo time_difference($row["fac_created_at"]) ?></span>
                                                    <div class="mt-2">
                                                        <a href="profile/index.php?emd_department_hash=<?php echo convert_string('decrypt',$row["fac_hash"]) ?>&&em_admin=<?php echo convert_string('decrypt',$user->data()->passkey) ?>" class="btn btn-light btn-icon btn-hover-primary btn-sm">
												...
												<div class="d-flex justify-content-between flex-column pt-4 h-100">
													...
													<div class="pb-5">
														...
														<div class="d-flex flex-column flex-center">
															...
															<!--end::Symbol-->
															<!--begin::Username-->
															<a href="profile/index.php?emd_department_hash=<?php echo convert_string('decrypt',$row->fac_hash) ?>&&em_admin=<?php echo convert_string('decrypt',$user->data()->passkey) ?>" class="card-title font-weight-bolder text-dark-75 text-hover-primary font-size-h4 m-0 pt-7 pb-1"><?php echo $row->fac_name ?></a>
															<!--end::Username-->
															<!--begin::Info-->
