                                        ...
                                        <div class="card card-custom card-stretch">
                                            ...
                                            <div class="card-body pt-4">
                                                ...
                                                <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                                                    ...
                                                    <div class="navi-item mb-2">
                                                        <a href="ett_account-information.php?emd_department_hash=<?php echo escape(convert_string('decrypt',$data->fac_hash)); ?>&em_admin=admin" class="navi-link py-4 active">
                                                            <span class="navi-icon mr-2">
                                                                <span class="svg-icon">
                                            ...
                                            <div class="card card-custom card-stretch" id="kt_page_sticky_card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-6">                                                            
                                                            <select class="form-control selectpicker" id="ett_mentor" name="ett_mentor" data-style="btn-warning">
                                                                <option value="<?php echo escape(convert_string('decrypt', $data->fac_mentor_hash)) ?>"><?php echo $data->fac_mentor ?></option>
                                                                <?php
                                                                $query = "SELECT * FROM em_faculty WHERE fac_passkey != :pass";
                                                                $statement = $connect->prepare($query);
                                                                $statement->execute(array(
                                                                    ':pass' => $data->fac_mentor_hash
                                                                ));
                                                                if ($statement->rowCount() > 0) {
                                                                    $result = $statement->fetchAll();
                                                                    foreach ($result as $row) {
                                                                ?>
                                                                        <option value="<?php echo escape(convert_string('decrypt', $row["fac_passkey"])) ?>"><?php echo $row["fac_name"] ?></option>
                                                                <?php
                                                                    }
                                                                }
                                                                ?>
                                                    ...
                                                    <!--begin::Form Group-->
                                                    <div class="form-group row">
                                                        <label class="col-xl-3 col-lg-3 col-form-label">Year</label>
                                                        <div class="col-lg-9 col-xl-6">
                                                            
                                                            <select class="form-control selectpicker" id="ett_year" name="ett_year" data-style="btn-primary">
                                                                
                                                                <option value="1" <?php if($data->fac_year == '1'){echo 'selected';} ?>>1st Year</option>
                                                                <option value="2" <?php if($data->fac_year == '2'){echo 'selected';} ?>>2nd Year</option>
                                                                <option value="3" <?php if($data->fac_year == '3'){echo 'selected';} ?>>3rd Year</option>
                                                                <option value="4" <?php if($data->fac_year == '4'){echo 'selected';} ?>>4th Year</option>
                                                            </select>                                                   
                                                        </div>
                                                    </div>
