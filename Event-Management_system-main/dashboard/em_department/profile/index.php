...
?>
    ...
    ?>
            ...
            <head>
                <meta charset="utf-8" />
                <title><?php echo escape($data->dept_name) ?> | Profile Overview</title>
                ...
                <div class="d-flex flex-column-fluid flex-column flex-row-fluid wrapper" id="kt_wrapper">
                            ...
                            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                                ...
                                <div class="d-flex align-items-start flex-wrap mr-1">
                                    ...
                                    <div class="d-flex align-items-baseline flex-wrap">
                                        <!--begin::Page Title-->
                                        <h5 class="text-dark font-weight-bold my-1 mr-4">EMS@KIOT</h5>
                                        <!--end::Page Title-->
                                        <!--begin::Breadcrumb-->
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="d-flex flex-row">
                                            ...
                                            <div class="card-body pt-4">
                                                ...
                                                <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                                                    <div class="navi-item mb-2">
                                                        <a href="index.php?emd_department_hash=<?php echo escape(convert_string('decrypt', $data->dept_hash)); ?>&em_admin=admin" class="navi-link py-4 active">
                                    ...
                                    <div class="flex-row-fluid ml-lg-8">
                                        ...
                                        <div class="row">
                                            <?php
                                            $fac = $db->get('em_students', array('fac_dept_hash', '=', $data->dept_passkey));
                                            if ($fac->count()) {
                                                $i = 0;
                                        ...
                                        <div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
                                            ...
                                            <div class="alert-text font-size-h3 font-weight-bold">Faculty Details </div>
                                            <div class="card-toolbar">
                                                <!--begin::Button-->
                                        ...
                                        <div class="row">
                                            <?php
                                            $fac = $db->get('em_faculty', array('fac_dept_hash', '=', $data->dept_passkey));
                                            if ($fac->count()) {
                                                $i = 0;
                                                foreach ($fac->results() as $row) {
                                                    $i++;
                                        ...
                                        <div class="card card-custom gutter-b">
                                            ...
                                            <div class="card-header border-0 pt-5">
                                                <h3 class="card-title align-items-start flex-column">
                                                    <span class="card-label font-weight-bolder text-dark">Faculty Informations</span>
                                                            ...
                                                            if ($fac->count()) {
                                                                foreach ($fac->results() as $row) { ?>
                                                                    <tr>
                                                                        ...
                                                                        <td class="pl-0">
                                                                            <a href="../../em_faculty/profile/index.php?emd_department_hash=<?php echo convert_string('decrypt', $row->fac_passkey) ?>&&admin=<?php echo convert_string('decrypt', $user->data()->passkey) ?>" class="text-info font-weight-bolder text-hover-primary mb-1 font-size-lg"><?php echo $row->fac_name ?></a>
                                                                        ...
                                                                        <td class="text-right pr-0">
                                                                            <span class="text-info font-weight-bolder d-block font-size-lg"><?php echo $row->fac_designation ?></span>
                                                                            <span class="text-muted font-weight-bold"><?php echo $row->fac_qualification ?></span>
                                                                        </td>
                                                                        <td class="text-right pr-0">
                                                                            <span class="text-info font-weight-bolder d-block font-size-lg"><?php echo $row->fac_department ?></span>
                                                                            <span class="text-muted font-weight-bold"><?php echo $row->fac_role ?></span>
                                                                        </td>
                                                                        <td class="text-right pr-0">
                                                                            <span class="text-info font-weight-bolder d-block font-size-lg"><?php echo $row->fac_address ?></span>
                                                                            <span class="text-muted font-weight-bold"><?php echo $row->fac_created_at ?></span>
                                                                        </td>
                                                                        <td class="text-right">
                                                                        ...
                                                                        <td class="pr-0 text-right">
                                                                            ...
                                                                            <button type="button" id="<?php echo convert_string('decrypt', $row->fac_hash) ?>" data-status="<?php echo $row->fac_status ?>" class="ett_delete btn btn-icon btn-light btn-hover-primary btn-sm mt-1 mr-3">
                                                                                <span class="svg-icon svg-icon-md svg-icon-primary">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                    <tr>
                                                                        ...
                                                                        <td class="pl-0">
                                                                            <a href="../../em_faculty/profile/index.php?emd_department_hash=<?php echo convert_string('decrypt', $row->fac_passkey) ?>&&admin=<?php echo convert_string('decrypt', $user->data()->passkey) ?>" class="text-danger font-weight-bolder text-hover-primary mb-1 font-size-lg"><?php echo $row->fac_name ?></a>
                                                                            <span class="text-muted font-weight-bold d-block mt-1 mb-1"><?php echo $row->fac_email ?></span>
                                                                            <span class="text-muted font-weight-bold d-block"><?php echo $row->fac_phone ?></span>
                                                                        </td>
                                                                        <td class="text-right pr-0">
                                                                            <span class="text-danger font-weight-bolder d-block font-size-lg"><?php echo $row->fac_gender ?></span>
                                                                        ...
                                                                        <td class="text-right pr-0">
                                                                            <span class="text-danger font-weight-bolder d-block font-size-lg"><?php echo $row->fac_department ?></span>
                                                                        ...
                                                                        <td class="pr-0 text-right">
                                                                            ...
                                                                            <button type="button" id="<?php echo convert_string('decrypt', $row->fac_hash) ?>" data-status="<?php echo $row->fac_status ?>" class="ett_deletes btn btn-icon btn-light btn-hover-primary btn-sm mt-1 mr-3">
                                                                                <span class="svg-icon svg-icon-md svg-icon-primary">
                                                                                    <!--begin::Svg Icon | path:/metronic/theme/html/demo11/dist/assets/media/svg/icons/General/Trash.svg-->
                                                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <script type="text/javascript" language="javascript">
                        $(document).ready(function() {
                            ...
                            $(document).on('submit', '#department_forms', function(event) {
                                event.preventDefault();
                                var form_data = $(this).serialize();
                                $.ajax({
                                    url: "emd_inserts.php",
                            ...
                            $(document).on('click', '.ett_edits', function() {
                                ...
                                $.ajax({
                                    ...
                                    success: function(data) {
                                        ...
                                        $("#ett_passwords").prop("type", "text");
                                        $("#ett_cpasswords").prop("type", "text");
                                        $(".teacher_action").val('Back');
                                        $('#ett_names').val(data.te_name);
                                        $('#kt_datepicker_3').val(data.te_dob);
                                        $('#ett_phones').val(data.te_phone);
                                        $('#ett_emails').val(data.te_email);
                                        $('#ett_mentors').val(data.te_mentor).change();
                                        $('#ett_depts').val(data.te_dept).change();
                                        $('#ett_years').val(data.te_year).change();
                                        $('#ett_gens').val(data.te_gen).change();
                                        $('#ett_locations').val(data.te_location);
                                        $('#ett_rolls').val(data.te_roll);
                                        $('#ett_usernames').val(data.te_username);
                                        $('#ett_passwords').val(data.te_password);
                                        $('#ett_cpasswords').val(data.te_password);
                                        $('#ett_passkeys').val(data.te_passkey);
                                        $('#ett_hashs').val(data.te_token);
                            ...
                            $(document).on('click', '#gen_passkeys', function() {
                                var passkey = generate_passkey(60);
                                document.getElementById("ett_passkeys").value = passkey;
                            });

                            $(document).on('click', '#gen_tokens', function() {
                                var token = generate_token(60);
                                document.getElementById("ett_hashs").value = token;
                            });
