                                ...
                                <div class="d-flex align-items-start flex-wrap mr-1">
                                    ...
                                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                                        ...
                                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="#" class="text-muted">Students Information</a>
                                            </li>
                                        </ul>
                                        <!--end::Breadcrumb-->
                                    </div>
                                        ...
                                        <div class="card card-custom card-stretch">
                                            ...
                                            <div class="card-body pt-4">
                                                ...
                                                <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                                                    ...
                                                    <div class="navi-item mb-2">
                                                        <a href="ema_student.php?emd_department_hash=<?php echo escape(convert_string('decrypt', $data->dept_hash)); ?>&em_admin=admin" class="navi-link py-4 active" data-toggle="tooltip" title="Students Details" data-placement="right">
                                                            <span class="navi-icon mr-2">
                                                                <span class="svg-icon">
                                                            ...
                                                            <div class="card-body d-flex flex-column bg-white shadow-sm border-1 border-bottom justify-content-between ribbon ribbon-top">
                                                                ...
                                                                <div class="rounded text-center mb-7 pt-7">
                                                                    <?php if ($row->fac_image) { ?>
                                                                        <div class="symbol symbol-60 symbol-xxl-100 symbol-circle align-self-start align-self-xxl-center">
                                                                ...
                                                                <div class="text-center">
                                                                    <h3 class="font-size-h1">
                                                                        <a href="../../em_student/profile/index.php?emd_department_hash=<?php echo convert_string('decrypt', $row->fac_hash) ?>&&admin=<?php echo convert_string('decrypt', $user->data()->passkey) ?>" class="text-dark font-weight-bolder text-hover-info"><?php echo $row->fac_name ?></a>
                                                                    </h3>
                                                                    <div class="font-size-h4 text-primary"><span class="label label-lg label-light-info label-inline mr-2"><?php echo $row->fac_gender ?></span></div>
                                                                    <!--begin::Contact-->
                                                                    <div class="py-9">
                                                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                                                            <span class="font-weight-bold mr-2">Email:</span>
                                                                        ...
                                                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                                                            ...
                                                                            <span class="text-muted"><?php echo escape($row->fac_dob); ?></span>
                                                                        </div>
                                                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                                                            <span class="font-weight-bold mr-2">Mentor:</span>
                                                                            <span class="label label-lg label-light-dark label-inline"><?php echo escape($row->fac_mentor); ?></span>
                                                                        </div>
                                                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                                                            <span class="font-weight-bold mr-2">Location:</span>
                                        ...
                                        <div class="card card-custom card-border gutter-b">
                                            ...
                                            <div class="card-header border-0 py-5">
                                                <h3 class="card-title align-items-start flex-column">
                                                    <span class="card-label font-weight-bolder text-dark">Students Details</span>
                                                    ...
                                                    <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                                                        <thead>
                                                            <tr class="text-uppercase">
                                                                ...
                                                                <th class="pr-0 text-right" style="min-width: 100px"><span class="text-primary">action</span></th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            ...
                                                            if ($fac->count()) {
                                                                ...
                                                                foreach ($fac->results() as $row) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <span class="text-warning font-weight-bolder d-block font-size-lg"><?php echo $row->fac_gender; ?></span>
                                            ...
                                            <div class="card-header flex-wrap py-5">
                                                <div class="card-title">
                                                    <h3 class="card-label">Students Details
                                                        <div class="text-muted pt-2 font-size-sm">View all Students details</div>
                                                    </h3>
                                                </div>
                                                <div class="card-toolbar">
                                                    <!--begin::Dropdown-->
                                                    ...
                                                    <!--end::Dropdown-->
                                                    <!--begin::Button-->
                                                    <button class="btn btn-info font-weight-bolder" data-toggle="modal" data-target="#DepartmentModel" id="add_department">
                                                        <span class="svg-icon svg-icon-md">
                                                            <!--begin::Svg Icon | path:/metronic/theme/html/demo6/dist/assets/media/svg/icons/Design/Flatten.svg-->
                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
