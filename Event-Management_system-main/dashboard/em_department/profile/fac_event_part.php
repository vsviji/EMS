                                ...
                                <div class="d-flex align-items-start flex-wrap mr-1">
                                    ...
                                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                                        ...
                                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="#" class="text-muted">Faculty Event Participated</a>
                                            </li>
                                        </ul>
                                        <!--end::Breadcrumb-->
                                    </div>
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="d-flex flex-row">
                                        ...
                                        <div class="card card-custom card-stretch">
                                            ...
                                            <div class="card-body pt-4">
                                                ...
                                                <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                                                    ...
                                                    <div class="navi-item mb-2">
                                                        <a href="fac_event_part.php?emd_department_hash=<?php echo escape(convert_string('decrypt', $data->dept_hash)); ?>&em_admin=admin" class="navi-link py-4 active" data-toggle="tooltip" title="Faculty" data-placement="right">
                                                            <span class="navi-icon mr-2">
                                                                <span class="svg-icon">
                                                                    <!--begin::Svg Icon | path:/metronic/theme/html/demo6/dist/assets/media/svg/icons/Files/File.svg-->
                                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    ...
                                    <div class="flex-row-fluid ml-lg-8">
                                        ...
                                        <div class="row">
                                            <?php
                                            $event = $db->get('fac_event', array('fe_dept_hash', '=', $data->dept_passkey));
                                            if ($event->count()) {
                                                $i = 0;
                                        ...
                                        <div class="card card-custom card-border gutter-b">
                                            ...
                                            <div class="card-header border-0 py-5">
                                                <h3 class="card-title align-items-start flex-column">
                                                    <span class="card-label font-weight-bolder text-dark">Faculty Event Participated</span>
                                                    <span class="text-muted mt-3 font-weight-bold font-size-sm">More than <?php echo $user->fac_event_part($data->dept_passkey); ?>+ new event</span>
                                                </h3>
                                            </div>
                                            <!--end::Header-->
                                            <!--begin::Body-->
