                                ...
                                <div class="d-flex align-items-start flex-wrap mr-1">
                                    ...
                                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                                        ...
                                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="#" class="text-muted">Faculty Information</a>
                                            </li>
                                        </ul>
                                        <!--end::Breadcrumb-->
                                    </div>
                                        ...
                                        <div class="card card-custom card-stretch">
                                            ...
                                            <div class="card-body pt-4">
                                                ...
                                                <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                                                    ...
                                                    <div class="navi-item mb-2">
                                                        <a href="ema_faculty.php?emd_department_hash=<?php echo escape(convert_string('decrypt', $data->dept_hash)); ?>&em_admin=admin" class="navi-link py-4 active" data-toggle="tooltip" title="Faculty Details" data-placement="right">
                                                            <span class="navi-icon mr-2">
                                                                <span class="svg-icon">
                                                        ...
                                                        <div class="card card-custom card-stretch gutter-b">
                                                            ...
                                                            <div class="card-body d-flex flex-column bg-white shadow-sm border-1 border-bottom justify-content-between ribbon ribbon-top">
                                                                ...
                                                                <div class="ribbon-target <?php echo $bg ?>" style="top: -2px; right: 20px;">
                                                                    <?php echo $row->fac_role ?>
                                                                </div>
                                                                <div class="rounded text-center mb-7 pt-7">
                                                                    <?php if ($row->fac_image) { ?>
                                                                        <div class="symbol symbol-xxl-100 symbol-circle align-self-start align-self-xxl-center">
                                                                            <img src="data:image/png;base64,<?php echo base64_encode($row->fac_image) ?>" style="transform: scale(1.4);">
                                                                        </div>

                                                                    <?php } else { ?>
                                                                        <div class="symbol symbol-xxl-100 align-self-start align-self-xxl-center">
                                                                ...
                                                                <div class="text-center">
                                                                    ...
                                                                    <div class="font-size-h4 text-primary"><span class="label label-light-info label-inline mr-2"><?php echo $row->fac_designation ?></span></div>
                                                                    <!--begin::Contact-->
                                                                    <div class="py-9">
                                                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                                                            <span class="font-weight-bold mr-2">Email:</span>
                                                                            <a href="#" class="text-muted text-hover-primary"><?php echo escape($row->fac_email); ?></a>
                                                                        </div>
                                                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                                                            <span class="font-weight-bold mr-2">Phone:</span>
                                                                            <span class="text-muted"><?php echo escape($row->fac_phone); ?></span>
                                                                        </div>
                                                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                                                            <span class="font-weight-bold mr-2">Location:</span>
                                                                            <span class="text-muted"><?php echo escape($row->fac_address); ?></span>
                                                                        </div>
                                                                        <div class="d-flex align-items-center justify-content-between">
                                                                            <span class="font-weight-bold mr-2">Joined at:</span>
                                                                            <span class="text-muted"><?php echo escape($row->fac_created_at); ?></span>
                                                                        </div>
                                                                    </div>
                                                                    <!--end::Contact-->
                                                                </div>
                                                                <span class="border border-bottom <?php echo $bgs ?>"></span>
                                                                <span class="border border-bottom <?php echo $bgs ?>"></span>
                                                                <span class="border border-bottom <?php echo $bgs ?>"></span>
                                                                <span class="border border-bottom <?php echo $bgs ?>"></span>
                                                            </div>
                                        ...
                                        <div class="card card-custom card-border gutter-b">
                                            ...
                                            <div class="card-header border-0 py-5">
                                                <h3 class="card-title align-items-start flex-column">
                                                    <span class="card-label font-weight-bolder text-dark">Faculty Details</span>
                                                    ...
                                                    <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                                                        <thead>
                                                            <tr class="text-uppercase">
                                                                ...
                                                                <th style="min-width: 120px"><span class="text-primary">Designation</span></th>
                                                                <th style="min-width: 100px">
                                                                    <span class="text-primary">Qualification</span>
                                                                </th>
                                                                <th style="min-width: 100px"><span class="text-primary">Department</span></th>
                                                                <th style="min-width: 80px"><span class="text-primary">Role</span></th>
                                                                <th style="min-width: 100px"><span class="text-primary">Location</span></th>
                                                                <th style="min-width: 100px"><span class="text-primary">status</span></th>
                                                                <th style="min-width: 100px"><span class="text-primary">Created at</span></th>
                                                                <th class="pr-0 text-right" style="min-width: 160px"><span class="text-primary">action</span></th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            ...
                                                            if ($fac->count()) {
                                                                ...
                                                                foreach ($fac->results() as $row) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="pl-0">
                                                                            <a href="../../em_faculty/profile/index.php?emd_department_hash=<?php echo convert_string('decrypt', $row->fac_passkey) ?>&&admin=<?php echo convert_string('decrypt', $user->data()->passkey) ?>" class="text-info font-weight-bolder text-hover-primary font-size-lg"><?php echo $row->fac_name; ?></a>
                                                                        </td>
                                                                        <td>
                                                                            <span class="text-warning font-weight-bolder d-block font-size-lg"><?php echo $row->fac_designation; ?></span>

                                                                        </td>
                                                                        <td>
                                                                            <span class="text-danger font-weight-bolder d-block font-size-lg"><?php echo $row->fac_qualification; ?></span>
                                                                        </td>
                                                                        <td>
                                                                            <span class="text-info font-weight-bolder d-block font-size-lg"><?php echo $row->fac_department; ?></span>
                                                                            <span class="text-muted font-weight-bold"><?php echo $data->dept_sname; ?></span>
                                                                        </td>
                                                                        <td>
                                                                            <span class="label label-lg label-light-danger label-inline"><?php echo $row->fac_role; ?></span>
                                                                        </td>
                                                                        <td>
                                                                            <span class="text-danger font-weight-bolder d-block font-size-lg"><?php echo $row->fac_address; ?></span>
                                                                        </td>
                                                                        <td>
                                                                            <span class="label label-lg label-light-primary label-inline"><?php echo $row->fac_status; ?></span>
                                                                        </td>
                                                                        <td>
                                                                            <span class="text-info font-weight-bolder d-block font-size-lg"><?php echo $row->fac_created_at; ?></span>
                                                                        </td>
