                        ...
                        <div class="col-xl-4">
                            <div class="card card-custom card-stretch bg-light-danger gutter-b">
                                ...
                                <div class="card-body pt-8">
                                    <?php 
                                        $query = "SELECT * FROM em_department ORDER BY dept_id DESC";
                                    ...
                                    ?>                                        
                                        ...
                                        <div class="d-flex align-items-center mb-10">
                                            ...
                                            <div class="d-flex flex-column font-weight-bold flex-grow-1">
                                                <a href="profile/index.php?emd_department_hash=<?php echo convert_string('decrypt',$row["dept_passkey"]) ?>&&em_admin=<?php echo convert_string('decrypt',$user->data()->passkey) ?>" class="text-dark text-hover-primary mb-1 font-size-lg"><?php echo $row["dept_name"] ?></a>
                                                <span class="text-muted"><i class="fa fa-clock text-danger fa-1x mr-2"></i><?php echo time_difference($row["dept_created_at"]) ?></span>
                                                <div class="mt-2">
                                                    <a href="profile/index.php?emd_department_hash=<?php echo convert_string('decrypt',$row["dept_passkey"]) ?>&&em_admin=<?php echo convert_string('decrypt',$user->data()->passkey) ?>" class="btn btn-light btn-icon btn-hover-primary btn-sm">
                                                    ...
                                                    <button id="<?php echo convert_string('decrypt',$row["dept_hash"]) ?>" class="ett_edit btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
                                                        <span class="svg-icon svg-icon-md svg-icon-info">
                                                    ...
                                                    <button id="<?php echo convert_string('decrypt',$row["dept_hash"]) ?>" data-status="<?php echo  $row["dept_status"] ?>" class="ett_delete btn btn-icon btn-light btn-hover-primary btn-sm">
                                                        <span class="svg-icon svg-icon-md svg-icon-info">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    <div class="card card-custom gutter-b">
                                        ...
                                        <div class="ribbon-target <?php echo $bg ?>" style="top: -2px; right: 20px;"><?php echo $row["dept_status"] ?></div>                                            
