                                    ...
                                    <div class="card card-custom card-stretch">
                                        ...
                                        <div class="card-body pt-4">                                            
                                            ...
                                            <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                                                ...
                                                <div class="navi-item mb-2">
                                                    <a href="ett_personal-information.php?emd_department_hash=<?php echo escape(convert_string('decrypt',$data->fac_passkey)); ?>&em_admin=admin" class="navi-link py-4 active">
                                                        <span class="navi-icon mr-2">
                                                            <span class="svg-icon">
                                        ...
                                        <div class="card card-custom card-stretch" id="kt_page_sticky_card">
                                            ...
                                            <div class="card-header py-3">
                                                <div class="card-title align-items-start flex-column">
                                                    ...
                                                    <span class="text-muted font-weight-bold font-size-sm mt-1">Update Faculty personal information</span>
                                                </div>
                                            ...
                                            <div class="card-body">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-6">
                                                            <input class="form-control form-control-lg form-control-solid" type="text" name="te_qua" id="te_qua" value="<?php echo escape($data->fac_qualification); ?>" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-xl-3 col-lg-3 col-form-label">Designation</label>
                                                        <div class="col-lg-9 col-xl-6">
                                                            <input class="form-control form-control-lg form-control-solid" type="text" name="te_des" id="te_des" value="<?php echo escape($data->fac_designation); ?>" />
                                                        </div>
                                                    </div>
