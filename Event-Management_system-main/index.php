...
<!-- Body-->
<!-- Bootstrap CSS (add this if you haven't included it yet) -->
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
...
<body style="background-color: #f7f7fc">
    ...
    <main class="cs-page-wrapper d-flex flex-column">
        ...
        <!-- Hero-->
        <section class="bg-size-cover overflow-hidden pt-5 pt-md-6 pt-lg-7" style="max-height: 1000px; background-image: url(img/demo/event-landing/hero-bg.jpg);">
            <div class="container pt-2 pb-4 pb-md-2">
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-7 col-md-8 text-center">
                        ...
                        <div class="d-inline-flex align-items-center mx-1 px-3 mb-4"><i class="fe-phone h2 mb-0 mr-2 text-light"></i><span class="text-light">+91 9543067220</span></div>
    ...
    <footer class="cs-footer py-4">
        <div class="container d-md-flex align-items-center justify-content-between py-2 text-center text-md-left">
            ...
            <p class="font-size-sm mb-0 mr-3 order-md-1">
                <span class="text-muted mr-1"></span><a class="nav-link-style font-weight-normal" href="" target="_blank" rel="noopener"></a>
            </p>
        </div>
    </footer>
